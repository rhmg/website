			...
			<li class="row<?php if (!($_searchresults_val['S_ROW_COUNT'] & 1)  ) {  ?> bg1<?php } else { ?> bg2<?php } ?>">
				<dl class="icon" style="background-image: url(<?php echo $_searchresults_val['TOPIC_FOLDER_IMG_SRC']; ?>); background-repeat: no-repeat;">
					...
					<dd class="lastpost"><span>
						...
						<?php if (! $this->_rootref['S_IS_BOT']) {  ?><a href="<?php echo $_searchresults_val['U_LAST_POST']; ?>"><?php echo (isset($this->_rootref['LAST_POST_IMG'])) ? $this->_rootref['LAST_POST_IMG'] : ''; ?></a> <?php } ?><br /><?php echo ((isset($this->_rootref['L_POSTED_ON_DATE'])) ? $this->_rootref['L_POSTED_ON_DATE'] : ((isset($user->lang['POSTED_ON_DATE'])) ? $user->lang['POSTED_ON_DATE'] : '{ POSTED_ON_DATE }')); ?> <?php echo $_searchresults_val['LAST_POST_TIME']; ?><br /> </span>
					</dd>
				</dl>
			</li>
		<?php }} ?>
	...
	<?php if ($_searchresults_val['S_IGNORE_POST']) {  ?>
		...
		<div class="postbody">
		    <div class="post-content">
    			<div class="ignore"><?php echo $_searchresults_val['L_IGNORE_POST']; ?></div>
			</div>
		</div>
		...
		<div class="postprofile">
            <div class="profile-top">
                <p class="profile-author">
    			    <?php echo $_searchresults_val['POST_AUTHOR_FULL']; ?>

	            </p>		    
            </div>
            <div class="profile-details">
                <p><?php echo $_searchresults_val['POST_DATE']; ?></p>
			<?php if ($_searchresults_val['FORUM_TITLE']) {  ?>

				<p><strong><?php echo ((isset($this->_rootref['L_FORUM'])) ? $this->_rootref['L_FORUM'] : ((isset($user->lang['FORUM'])) ? $user->lang['FORUM'] : '{ FORUM }')); ?>:</strong> <a href="<?php echo $_searchresults_val['U_VIEW_FORUM']; ?>"><?php echo $_searchresults_val['FORUM_TITLE']; ?></a></p>
				<p><strong><?php echo ((isset($this->_rootref['L_TOPIC'])) ? $this->_rootref['L_TOPIC'] : ((isset($user->lang['TOPIC'])) ? $user->lang['TOPIC'] : '{ TOPIC }')); ?>:</strong> <a href="<?php echo $_searchresults_val['U_VIEW_TOPIC']; ?>"><?php echo $_searchresults_val['TOPIC_TITLE']; ?></a></p>
			<?php } else { ?>

				<p><strong><?php echo ((isset($this->_rootref['L_GLOBAL'])) ? $this->_rootref['L_GLOBAL'] : ((isset($user->lang['GLOBAL'])) ? $user->lang['GLOBAL'] : '{ GLOBAL }')); ?>:</strong> <a href="<?php echo $_searchresults_val['U_VIEW_TOPIC']; ?>"><?php echo $_searchresults_val['TOPIC_TITLE']; ?></a></p>
			<?php } ?>

    			<p><strong><?php echo ((isset($this->_rootref['L_REPLIES'])) ? $this->_rootref['L_REPLIES'] : ((isset($user->lang['REPLIES'])) ? $user->lang['REPLIES'] : '{ REPLIES }')); ?>:</strong> <?php echo $_searchresults_val['TOPIC_REPLIES']; ?></p>
	    		<p><strong><?php echo ((isset($this->_rootref['L_VIEWS'])) ? $this->_rootref['L_VIEWS'] : ((isset($user->lang['VIEWS'])) ? $user->lang['VIEWS'] : '{ VIEWS }')); ?>:</strong> <?php echo $_searchresults_val['TOPIC_VIEWS']; ?></p>
	    	</div>
	    </div>
