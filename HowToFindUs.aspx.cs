    ...
    public partial class HowToFindUs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            master.ConfigurePage(SiteSection.Contact,
                Pages.howToFindUs,
                new PageTitle("Rock Hard Music Group - How to find the Recording and Rehearsal Rooms, Blackpool"),
                new PageSubTitle("Rock Hard Music Group - Providing pro musical services to the musical community"),
                new PageDescription("How to find us, including written directions and a google map. Location of Recording and Rehearsal Studio in Blackpool"),
