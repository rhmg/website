...
<?php } if ($this->_rootref['S_SHOW_GROUP']) {  ?>
	...
	<div class="forumbg forumbg-table">
		...
		<table class="table1" cellspacing="<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_TABLE_SPACING'])) ? $this->_tpldata['DEFINE']['.']['CA_TABLE_SPACING'] : ''; ?>" id="memberlist">
		<thead>
		<tr>
...
<div class="forumbg forumbg-table">
	...
	<table class="table1" cellspacing="<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_TABLE_SPACING'])) ? $this->_tpldata['DEFINE']['.']['CA_TABLE_SPACING'] : ''; ?>">
	<thead>
	<tr>
	<?php if (! $this->_rootref['S_LEADERS_SET']) {  ?>
