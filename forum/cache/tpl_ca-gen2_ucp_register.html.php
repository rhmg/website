...
<div class="panel">
	...
	<dl>
		...
		<dd><?php echo ((isset($this->_rootref['L_CONFIRM_CODE_EXPLAIN'])) ? $this->_rootref['L_CONFIRM_CODE_EXPLAIN'] : ((isset($user->lang['CONFIRM_CODE_EXPLAIN'])) ? $user->lang['CONFIRM_CODE_EXPLAIN'] : '{ CONFIRM_CODE_EXPLAIN }')); if ($this->_rootref['S_CONFIRM_REFRESH']) {  ?> <?php echo ((isset($this->_rootref['L_VC_REFRESH_EXPLAIN'])) ? $this->_rootref['L_VC_REFRESH_EXPLAIN'] : ((isset($user->lang['VC_REFRESH_EXPLAIN'])) ? $user->lang['VC_REFRESH_EXPLAIN'] : '{ VC_REFRESH_EXPLAIN }')); } ?></dd>
		<?php if ($this->_rootref['S_CONFIRM_REFRESH']) {  ?><dd><input type="submit" value="<?php echo ((isset($this->_rootref['L_VC_REFRESH'])) ? $this->_rootref['L_VC_REFRESH'] : ((isset($user->lang['VC_REFRESH'])) ? $user->lang['VC_REFRESH'] : '{ VC_REFRESH }')); ?>" class="button2" /></dd> <?php } ?>
