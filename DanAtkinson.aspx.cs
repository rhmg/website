...
{
    public partial class DanAtkinson : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            master.ConfigurePage(SiteSection.Home,
                Pages.theTeam,
                new PageTitle("Rock Hard Music Group - Dan Atkinson"),
                new PageSubTitle("Rock Hard Music Group - Providing pro musical services to the musical community"),
                new PageDescription("Meet Daniel Atkinson, one of our producers.  Dan is experienced in recording bands from all styles and is an exceptional producer."),
