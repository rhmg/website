    ...
    public partial class FreeRecordingAndRehearsalsDeal : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            master.ConfigurePage(SiteSection.Studio,
                ...
                new PageTitle("Rock Hard Studios - Free Recording and Rehearsals Deal at Blackpool Rehearsal Rooms and Recording Studio"),
                new PageSubTitle("Rock Hard Studios - Pro level recording and rehearsal for amazing prices"),
                new PageDescription("Free Recording and Rehearsals Deal at Blackpool Rehearsal Rooms and Recording Studio."),
